...
@FeignClient(name = NOTIFICATION_SERVICE, url = "${service.gateway-url}", path = API_V1_NOTIFICATION, contextId = "NotificationClient", configuration = FeignConfiguration.class)
